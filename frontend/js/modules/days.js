...
function getDaysSkeletonHTML() {
  return `
    <div class="day-card day-card-skeleton" id="day-card-skeleton" aria-hidden="true">
      <!-- Card Header: Title on left, single small status pill on right (no overlapping buttons) -->
      <div class="sk-header-row">
        <div class="sk-date-wrap">
          <div class="sk-shimmer sk-title"></div>
          <div class="sk-shimmer sk-subtitle"></div>
        </div>
        <div class="sk-shimmer sk-badge-pill"></div>
      </div>

      <!-- Progress Section -->
      <div class="sk-progress-wrap">
        <div class="sk-prog-meta">
          <div class="sk-shimmer sk-prog-label"></div>
          <div class="sk-shimmer sk-prog-pct"></div>
        </div>
        <div class="sk-prog-track">
          <div class="sk-shimmer sk-prog-fill"></div>
        </div>
      </div>
      ...
      <div class="sk-categories-wrap">
        ...
        <div class="sk-category-block">
          <div class="sk-category-header">
            ...
            <div class="sk-shimmer sk-cat-title" style="width: 110px;"></div>
